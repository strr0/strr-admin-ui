declare namespace NaiveUI {
  ...
  type TableColumnCheck = import('@/hooks/common').TableColumnCheck;
  type TableDataWithIndex<T> = import('@/hooks/common').TableDataWithIndex<T>;
  type FlatResponseData<T> = import('@/service/request/type').FlatResponseData<T>;
